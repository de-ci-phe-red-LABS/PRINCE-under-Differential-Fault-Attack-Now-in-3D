...
def Check_Pattern_State_8(faulty_nibble,K0prime_xor_k1):
    ...
    for k in range(2**16):
        ...
        if [len(e0),len(e1),len(e2),len(e3)]==Pattern_S8[faulty_nibble][0]:
            print("1",hex(k))
            K1_0.append(k)
        if [len(e4),len(e5),len(e6),len(e7)]==Pattern_S8[faulty_nibble][1]:
            print("2",hex(k))
            K1_1.append(k)
        if [len(e8),len(e9),len(e10),len(e11)]==Pattern_S8[faulty_nibble][2]:
            print("3",hex(k))
            K1_2.append(k)
        if [len(e12),len(e13),len(e14),len(e15)]==Pattern_S8[faulty_nibble][3]:
            print("4",hex(k))
            K1_3.append(k)
